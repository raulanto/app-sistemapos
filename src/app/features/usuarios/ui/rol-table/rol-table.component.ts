...
import { RolResponse } from '../../data-access/usuarios.models';
...
export class RolTableComponent {
  roles = input<RolResponse[]>([]);
  loading = input<boolean>(false);
  sort = input<string>('nombre:asc');
  canGestionar = input<boolean>(true);
  ...
  editar = output<RolResponse>();
  permisos = output<RolResponse>();
  eliminar = output<RolResponse>();
