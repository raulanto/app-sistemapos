import { Overlay, OverlayPositionBuilder, type ConnectedPosition, type FlexibleConnectedPositionStrategy, type OverlayRef } from '@angular/cdk/overlay';
import { TemplatePortal } from '@angular/cdk/portal';
import { isPlatformBrowser } from '@angular/common';
import { ChangeDetectionStrategy, Component, Directive, ElementRef, PLATFORM_ID, Renderer2, ViewContainerRef, ViewEncapsulation, booleanAttribute, computed, effect, inject, input, numberAttribute, output, signal, type InputSignal, type OnDestroy, type OnInit, type TemplateRef } from '@angular/core';
